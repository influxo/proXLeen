      ...
      <div className="flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="relative flex-1 border-l-2 border-orange-400 pl-4">
          ...
          <div className="absolute bottom-4 left-[-20px] bg-white p-4 rounded-lg shadow-lg">
            <div className="flex gap-1 justify-center mb-1">
              <span className="bg-gray-100 rounded-full w-8 h-8 flex items-center justify-center text-gray-600">
                👤
              </span>
              <span className="bg-gray-100 rounded-full w-8 h-8 flex items-center justify-center text-gray-600">
                👤
        ...
        <div className="flex-1 md:pl-8">
          ...
          <p className="text-gray-600 mb-8 leading-relaxed">
            ...
            environment, regardless of the type of space. At Aco Clean we are
