      ...
      <div className="mx-auto px-4 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex items-center z-10">
        <div className="max-w-2xl">
          ...
          <div className='flex-col'>
            <h1 className="text-5xl font-bold text-center text-white mb-4">Proffesional</h1>
            <div className='flex gap-4'>
            <h1 className="text-5xl font-bold bg-white p-2 text-[#515854] mb-4">cleaning</h1>
            <h1 className="text-5xl font-bold text-white p-2 mb-4">service</h1>
            </div>
          </div>
